...
const RestaurantCard = ({
  ...
  return (
    <div className=" w-72 min-w-[291px] sm:w-64 md:w-[311px] lg:w-[276px] xl:w-64 2xl:w-[310px] p-4 mb-4 mt-1 mx-1 hover:outline outline-1 outline-gray-300 hover:shadow-md">
